...
export default {
  ...
  methods: {
    handleClick() {
      ...
      if (eva == 'holland') {
        this.$router.push({ path: '/jg/evaluation/holland', query: { isShowModule: 1 } })
      } else if (eva == 'mbti') {
        this.$router.push({ path: '/jg/evaluation/mbti', query: { isShowModule: 1 } })
      } else if (eva == 'midas') {
        this.$router.push({ path: '/jg/evaluation/midas', query: { isShowModule: 1 } })
      } else {
        return;
      }
      // if (eva == 'holland') {
