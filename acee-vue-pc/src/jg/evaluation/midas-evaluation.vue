<template>
  <div 
    ...
    <div 
      ...
      class="choose-btn">
      <el-row>
        <router-link to="/jg/evaluation/result/midas" tag="el-button">查看测评结果</router-link>
...
export default {
  ...
  methods: {
    startEvaluation() {
      ...
      const vm = this;
      axios.get(`${PUBLIC_CDN_DOMAIN}/acee/wx/json/midas_ques.json`)
    ...
    postAns() {
      ...
      .then(function(response) {
        ...
        vm.$router.push('/jg/evaluation/result/midas')
