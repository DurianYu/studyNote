<template>
  <div 
    ...
    <div 
      ...
      class="choose-btn">
      <el-row>
        <router-link to="/jg/evaluation/result/mbti" tag="el-button">查看测评结果</router-link>
...
export default {
  ...
  methods: {
    startEvaluation: function() {
      ...
      axios.get(`${PUBLIC_CDN_DOMAIN}/acee/wx/json/MBTI.json`)
    ...
    submitAns: function() {
      ...
      .then(function(response) {
        ...
        vm.$router.push('/jg/evaluation/result/mbti')
