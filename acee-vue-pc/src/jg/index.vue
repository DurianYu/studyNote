<template>
  <div class="jg-index clearfix" ref="page">
    <el-row type="flex">
      <el-col
       :span="4"
       :lg="4"
...
export default {
  ...
  data () {
    return {
      ...
      province_url: store.state.userInfo.province ? store.state.userInfo.province : 'jg',
      showloading: false,
      dialogShow: {
        showModifyPw: false,
      },
      ...
      testData: [
        ...
        },
        {
          ...
          props: {
            index: '3',
            route: '/jg/manageCenter/mgrPeople'
          },
        },
        {
          type: 'item', 
          title: '报考形势', 
          props: {
            index: 'applySituation',
            route: '/jg/applySituation/chartFractionSeg'
          },
        },
        {
          type: 'item', 
...
<style type="text/css">
  ...
  .jg-index>.el-row>.left-col {
    align-items: stretch;
  }
  .jg-index>.el-row>.right-col {
    height: 100%;
  }
  .jg-index .el-input.is-disabled .el-input__inner {
    color: #636569;
  }
  /*左面搜索面板*/
   .jg-index .left-col {
  ...
  .jg-index .left-pane .login-box {
    background-color: #fff;
    margin: 0 0 0 0px; 
    padding: 0;
    height: 100%;
  }
  .jg-index .left-pane .login-box-img {
    width: 100%;
    height: 6rem;
    background-color: #f8f9fa !important;
  }
  .jg-index .left-pane .login-box-img img {
    width: auto;
    height: 6rem;
    display: table;
    margin: 0 auto; 
  ...
  .jg-index .left-pane .left-pane-content {
    height: calc(100% - 6rem);
    background-color: #fff;
  }
 /* .jg-index .left-pane .left-pane-content::-webkit-scrollbar {
    width: 5px;
    background-color: #fff;
  }

  .jg-index .left-pane .left-pane-content::-webkit-scrollbar-thumb {
    border-radius: 4px;
  ...
  .jg-index .page-content {
    height: calc(100% - 4rem);
    position: relative;
    border-top:1px solid transparent
  }

  .jg-index .doctor-master .el-dialog__footer {
    text-align: center;
  }
  .jg-index .modifyPassword .modify-node {
    padding: 14px 0px;
    font-size: 1rem;
    text-align: left;
  }
  .jg-index .modifyPassword .el-input {
    padding-left: 10px;
  }
