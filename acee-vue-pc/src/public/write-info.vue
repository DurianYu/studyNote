...
<el-row type="flex" justify="center" class="write-info">
  ...
  <el-col :span="9" :xs="16" :sm="12" :md="9" style="background: #eee;
    padding: 20px;
    ...
    submitMess: function () {
      ...
      axios({
        ...
        .then((response) => {
          ...
          if (res.status === 1) {
            this.store.setUserInfoAction(Object.assign({}, userInfo, {...res.data, logined: true}));
