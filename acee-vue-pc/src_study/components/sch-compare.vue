...
export default {
  ...
  methods: {
    openComList() {
      // /asypc/${store.state.userInfo.province}/college/compare
      axios.get(`/static/json/sch-cmp.json`, {
          // college1: schInfo.plan_id[0],
          // college2: schInfo.plan_id[1]
        })
        .then(res => {
          res = res.data;
          console.log(res);
