<template>
  <div class="holland-evaluation">
    <div 
      ...
      class="choose-btn">
      <el-row>
        <router-link to="/evaluation/result/holland" tag="el-button">查看测评结果</router-link>
...
export default {
  ...
  methods: {
    startEvaluation: function() { // 开始测评
      const vm = this;
      const {domain} = this;
      axios.get(`${domain}/acee/wx/json/hld-test.json`)
    ...
    submitAns: function() {
      ...
      axios({
        method: 'get',
        url: '/static/json/hld-result.json'
        // method: 'post',
      ...
      .then(function(response) {
        ...
        vm.$router.push('/evaluation/result/holland')
