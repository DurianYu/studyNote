  ...
  <div class="help-page-content" ref='helpContent'>
    <el-steps 
      ...
      :key="index">
        ...
        <img v-if="item.description" ref="img" src="/static/img/layer.jpg" slot="description" :data-src="item.description">
      </el-step>
    </el-steps>
  </div>
</template>
          ...
          funIntr: [
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/home_page.jpg',
              status: 'success'
            },
            {
              title: '电脑端操作简洁，适合对院校进行快速筛选，高考成绩公布后推荐使用电脑端。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/pc-search.jpg',
              status: 'success'
            },
            {
              title: '',
          ...
          funIntr: [
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/no_vip.jpg',
              status: 'success'
            },
            {
              title: '高级VIP用户可在此处查看院校是否有硕士、博士授予权。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/look_master.jpg',
              status: 'success'
            },
            {
              title: '点击查看按钮进入该院校硕士、博士专业详细研究方向页面。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/master_page.jpg',
              status: 'success'
            },
            {
              title: '高级VIP用户可在此处查看院校是否有硕士、博士授予权。',
       ...
       // 微信端注册
          ...
          funIntr: [
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/logo-qrcode.jpg',
              status: 'success'
            },
            {
              title: '首次进入公众号点击任意按钮，需要先填写基本信息',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/regist_note.jpg',
              status: 'success'
            },
            {
              title: '基本信息包括身份（学生、老师、家长）、省份、城市、毕业年份等。注意：个人信息只能填写一次，无法修改。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/wx_registe_info.jpg',
              status: 'success'
            },
            {
              title: '',
          ...
          funIntr: [
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/pc_sign.jpg',
              status: 'success'
            },
            {
              title: '如果未绑定志愿卡账号到微信，首次在电脑端使用账号密码登录时需要您填写省份、文理科、毕业年份信息。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/pc_register_prov.jpg',
              status: 'success'
            },
            {
              title: '',
        ...
        cardBind: {
          ...
          funIntr: [
            ...
            {
              title: '在弹出框中点击已有卡。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/card_bing_two.jpg',
              status: 'success'
            },
            {
              title: '输入卡号和密码，点击提交。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/card_bing_three.jpg',
              status: 'success'
            },
            {
              title: '',
          ...
          funIntr: [
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/parent_qr.jpg',
              status: 'success'
            },
            {
              title: '',
          ...
          funIntr: [
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/modify_school.jpg',
              status: 'success'
            },
            {
              title: '在智能推荐页面进入其学校优先、专业优先、收藏学校分析页面都可修改成绩。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/recommend_kinds.jpg',
              status: 'success'
            },
            {
              title: '个人中心页面，成绩信息可进入成绩修改页面。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/modify_my.jpg',
              status: 'success'
            },
            {
              title: '',
          ...
          funIntr: [
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/school_search.jpg',
              status: 'success'
            },
            {
              title: '搜索结果中就可看到学校情况及招生数据，点击卡片可查看更多信息。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/school_info.jpg',
              status: 'success'
            },
            {
              title: '院校具体专业的招生数据，可点击专业详情查看。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/enrollment_spec_info.jpg',
              status: 'success'
            },
            {
              title: '专业详细数据。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/enrollment_spec_data.jpg',
              status: 'success'
            },
            {
              title: '',
        ...
        enrollmentCharter: {
          ...
          funIntr: [
            ...
            },
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/enrollment_charter.jpg',
              status: 'success'
            },
            {
              title: '',
        ...
        schoolPriority: {
          ...
          funIntr: [
            ...
            },
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/recommend_pro.jpg',
              status: 'success'
            },
            {
              title: '系统为您推荐出冲刺型、稳定性、保底型3类院校。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/recommend_result.jpg',
              status: 'success'
            },
            {
              title: '',
        ...
        subjectPriority: {
          ...
          funIntr: [
            ...
            },
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/recommend_sub.jpg',
              status: 'success'
            },
            {
              title: '系统为您推荐出冲刺型、稳定性、保底型3类院校。',
        ...
        schoolAnalysis: {
          ...
          funIntr: [
            ...
            },
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/recommend_school.jpg',
              status: 'success'
            },
            {
              title: '',
          ...
          funIntr: [
            {
              ...
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/volunteer_school_join.jpg',
              status: 'success'
            },
            {
              title: '在志愿表中点击修改志愿，就可以删除和移动志愿学校。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/volunteer_modify.jpg',
              status: 'success'
            },
            {
              title: '点击清空按钮就可以清空该批次的志愿表。',
              description: `${store.state.PUBLIC_CDN_DOMAIN}` + '/img/help/volunteer_empty.jpg',
              status: 'success'
            },
            {
              title: '',
